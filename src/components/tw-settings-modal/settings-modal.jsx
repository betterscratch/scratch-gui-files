...
const DisableCompiler = props => (
    <BooleanSetting
        ...
        help={
            <FormattedMessage
                // eslint-disable-next-line max-len
                defaultMessage="Disables the compiler from TurboWarp. You may want to enable this while editing projects so that scripts update immediately. Otherwise, you should never enable this."
    ...
    <div className={styles.setting}>
        <div>
            ...
            <p>
                <FormattedMessage
                    // eslint-disable-next-line max-len
                    defaultMessage="Stores the selected settings in the project so they will be automatically applied when Better Scratch loads this project."
